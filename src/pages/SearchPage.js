...
function SearchPage () {
    const [ { term }, dispatch ] = useStateValue() // destructuring state to get search term
    ...
    return (
        <div className='searchPage'>
            ...
            {/* only render results if you've provided a search term */}
            {term && (
                <div className='searchPage__results'>
                    {/* the ?. is called optional chaining, its a tool for null checking, here we check if data is filled, 
                    had to install npm module, npm install --save-dev @babel/plugin-proposal-optional-chaining */}
